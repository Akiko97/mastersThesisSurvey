    ...
    },
    {
      ...
      elements: [
        ...
        },
        {
          type: "radiogroup",
          name: "question16",
          title: "例题中的代码片段3～6均使用了SIMD计算，即在单条指令中同时处理多个数据（如：进行批量计算或对数据进行混排等），您在理解这些代码的时候是否感到比理解非SIMD代码更有挑战？",
          choices: [
            "理解SIMD计算对我来讲更有挑战",
            "理解非SIMD计算对我来讲更有挑战",
            "二者对我来讲没有任何区别",
        ...
        },
        {
          type: "radiogroup",
          name: "question17",
          title: "您认为，可视化（包括静态和动态）是否会帮助您理解编程语言代码的具体含义？",
          choices: [
            "可视化能辅助我更快的把握代码的含义",
            "可视化对于我理解代码没有任何帮助",
        ...
        },
        {
          type: "radiogroup",
          name: "question18",
          title: "您认为，可视化（包括静态和动态）是否会帮助您理解SIMD计算的过程（即本问卷中展示的例题）？",
          choices: [
            "可视化能辅助我更快的把握代码的含义",
            "可视化对于我理解代码没有任何帮助",
            "我没接触过编程，但是通过可视化我理解了本问卷中的例题",
...
survey.onComplete.add((sender) => {
  saveSurveyResults(
      "http://157.7.194.160:12163/survey-data",
      sender.data
  )
})
